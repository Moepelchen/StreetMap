...
public class TexturedVertex {
	...
	public TexturedVertex(Vector4f pos1, ReadableColor color)
	{
		this.setXYZW(pos1.getX(),pos1.getY(),pos1.getZ(),pos1.getW());
		this.setRGBA((float)(color.getRed())/255.0f,(float)(color.getGreen())/255.0f,(float)(color.getBlue())/255.0f,0);
		//this.setRGBA(1.0f,0,0,1);
	}
