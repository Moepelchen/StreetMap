...
public class TheQuadExampleTextured {
	...
	private void setupTextures() {
		texIds[0] = this.loadPNGTexture("F:\\WorkspaceGIT2\\WorkspaceGIT\\StreetMap\\images\\streets\\BendNE.png", GL13.GL_TEXTURE0);
		texIds[1] = this.loadPNGTexture("F:\\WorkspaceGIT2\\WorkspaceGIT\\StreetMap\\images\\streets\\BendWN.png", GL13.GL_TEXTURE0);
	...
	private void setupQuad() {
		...
		v0.setXYZ(-0.5f, 0.5f, 0); v0.setRGB(1, 0, 0); v0.setUV(0, 0);
		TexturedVertex v1 = new TexturedVertex(); 
		v1.setXYZ(-0.5f, -0.5f, 0); v1.setRGB(0, 1, 0); v1.setUV(0, 1);
		TexturedVertex v2 = new TexturedVertex(); 
		v2.setXYZ(0.5f, -0.5f, 0); v2.setRGB(0, 0, 1); v2.setUV(1, 1);
		TexturedVertex v3 = new TexturedVertex(); 
		v3.setXYZ(0.5f, 0.5f, 0); v3.setRGB(1, 1, 1); v3.setUV(1, 0);
	...
	private void setupShaders() {		
		...
		vsId = this.loadShader("./config/shaders/vertex.glsl", GL20.GL_VERTEX_SHADER);
		// Load the fragment shader
		fsId = this.loadShader("./config/shaders/fragment.glsl", GL20.GL_FRAGMENT_SHADER);
